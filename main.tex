...
\newpage
\begin{abstract}
Dagens studieplan er evaluert med tanke på ...
\par
\vspace{0.5cm}
Arbeidsgruppen har gått igjennom gjeldende studieplan og kommentert denne. 
\par
\vspace{0.5cm}
Arbeidsgruppen har flere anbefalinger med tanke på mandatet den er gitt, de viktigste er 
\begin{itemize}
  \item Studentene bør gis en mer systematisk innføring i dokumentasjonspraksis (rapport skriving, journalføring, datainnsamling og kodedukumentasjon samt versjonskontroll av disse)
  \item Studentene bør gis en mer helhetlig opplæring i praktiske eksperimentelle ferdigheter
  \item Studentene bør gis en mer helhetlig opplæring i praktisk bruk av numeriske beregninger 
  \item Mye av den ''praktiske'' undervisningen er lagt opp som demonstrasjoner/illustrasjoner av fenomener i den ordinære undervisningen. Læringsutbytte ved denne formen for laboratorieoppgaver er ikke like stor som i de tilfeller hvor studentene selv må planlegge, etablere, gjennomføre, analysere og rapportere slike forsøk. 
  \item En ny ferdighetsstreng innen numeriske beregninger er under etablering, dette er et meget positivt initiativ som bør videreføres. Det gir alle MTFYMA og BFY studenter praktiske og fagrelevante ferdigheter innen beregningsorientert fysikk. 
\end{itemize}
\par
\vspace{0.5cm}
Med referanse til nest siste punkt, erkjenner arbeidsgruppen at det vil være mye mer omfattende å gjennomføre forsøk på denne måten. Men hvis studentene i første del av studiet lærte å arbeide som fysikere 
\end{abstract}
...
\begin{table}[!ht]
  ...
  \hline
  Kurskode & Kursnavn & SP & BFY & TFY & MA \\ \hline
